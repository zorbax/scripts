...
# Color palette inspired by IGV
igv_alternating = {"Indigo": "#5773CC", "SelectiveYellow": "#FFB900"}
...
scifi = {
    "npg_nrc": npg_nrc,
    "aaas_default": aaas_default,
    "nejm_default": nejm_default,
    "lancet_lanonc": lancet_lanonc,
    "jama_default": jama_default,
    "jco_default": jco_default,
    "ucscgb_default": ucscgb_default,
    "d3_category10": d3_category10,
    "d3_category20": d3_category20,
    "d3_category20b": d3_category20b,
    "d3_category20c": d3_category20c,
    "igv_default": igv_default,
    "igv_alternating": igv_alternating,
    "locuszoom_default": locuszoom_default,
    "uchicago_default": uchicago_default,
    "uchicago_light": uchicago_light,
    "uchicago_dark": uchicago_dark,
    ...
    "simpsons_springfield": simpsons_springfield,
    "futurama_planetexpress": futurama_planetexpress,
    "rickandmorty_schwifty": rickandmorty_schwifty,
    "startrek_uniform": startrek_uniform,
    "tron_legacy": tron_legacy,
    "gsea_default": gsea_default,
    ...
    "material_brown": material_brown,
    "material_grey": material_grey,
    "material_blue_grey": material_blue_grey,
}
